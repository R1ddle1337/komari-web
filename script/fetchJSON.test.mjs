...
test("canonical metric transport preserves samples and rejects retired formats", async () => {
  ...
  assert.throws(()=>decodeMetricResponse(legacy), /Unsupported metric point format/);
